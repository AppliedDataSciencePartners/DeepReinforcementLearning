...
def main():
    ...
    # If loading an existing neural network, copy the config file to the run folder and root
    if initialise.INITIAL_RUN_NUMBER != None:
        copyfile(run_archive_folder + '/' + env.name + '/run' + str(initialise.INITIAL_RUN_NUMBER).zfill(4) + '/config.py', run_folder + 'config.py')
